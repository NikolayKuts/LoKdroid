...
import com.lib.lokdroid.data.default_implementation.LogBuilderProvider
...
object LoKdroid {
     ...
     * @param logBuilderProvider A provider for [ILogBuilder] instances used for constructing log messages.
     */
    fun initialize(
    ...
    /**
     * Logs a message constructed using the specified [ILogBuilder] lambda at the designated level.
     * This allows for more complex log message construction.
     *
     * @param level The severity level of the log.
     * @param block A lambda block to configure the [ILogBuilder].
     */
    internal fun log(level: Level, block: ILogBuilder.() -> Unit) {
