...
import com.lib.lokdroid.data.default_implementation.MessageBuilder
...
object LoKdroid {
     ...
     * @param messageBuilderFactory A factory that creates a new [IMessageBuilder] for each complex message.
     */
    fun initialize(
