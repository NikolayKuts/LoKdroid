 ...
 * @property logBuilderProvider A provider that supplies [ILogBuilder] instances for constructing complex log messages.
 */
internal class LogManager(
    ...
    private val logBuilderProvider: ILogBuilderProvider,
) {
    ...
    /**
     * Logs a complex message constructed via [ILogBuilder] at the specified level if the level is above or equal to [minLevel].
