 ...
 * @property messageBuilderFactory A factory that supplies a new [IMessageBuilder] for constructing each complex message.
 */
internal class LogManager(
    ...
    private val messageBuilderFactory: () -> IMessageBuilder,
) {
    ...
    fun log(
        ...
        level.performByMinLevel {
            val messageBuilder = messageBuilderFactory()
